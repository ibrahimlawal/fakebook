		...
		<fieldset>
			...
			<input type="text" id="firstname" name="firstname" 
				 value="<% if(request.getParameter("firstname")!=null){out.println(request.getParameter("firstname"));} %>" />		<!--The firstname input box -->
			</div>
			<div class="field">
			<label for="lastname">Last name:</label>					<!--The lastname label -->
			<input type="text" id="lastname" name="lastname"  
				 value="<% if(request.getParameter("lastname")!=null){out.println(request.getParameter("lastname"));} %>" />			<!--The lastname input box -->
			</div>
			<div class="field">
		...
		<fieldset>
			...
			<input type="text" id="security_question" name="security_question"  
				 value="<% if(request.getParameter("security_question")!=null){out.println(request.getParameter("security_question"));} %>" />		<!--The security question input box -->
			</div>
			<div class="field">
